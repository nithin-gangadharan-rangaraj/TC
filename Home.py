        ...
        completion = client.chat.completions.create(
                          ...
                          messages=[
                            {"role": "system", "content": f'''You are a recruiter now. Analyse how good the user information fits the following recruiting job description.
                                                           ...
                                                           You have to provide a recommendation for the user in less than 100 words. Strategically combine the personality traits, if any in information given in the candidate information.
                                                           The job description is demilited by ####. The recommendation is how good the user fits the criteria in the job description.
                                                           You must answer it in the following format: 
                                                           Recommendation:
                                                           Personality traits:
                                                          '''},
                            {"role": "user", "content": f"{prompt}"}
...
def write_recommendation(client, candidate_df, recruiter):
    ...
    progress_bar.progress(1.0, text = "Candidates analyzed, ranking now...")
        ...
        completion = client.chat.completions.create(
                          ...
                          messages=[
                            ...
                            {"role": "user", "content": f'''You are a recruiter now. Consider this job description {recruiter['JobDescription']}.
                                                           ...
                                                           Both Name and Email are case sensitive. Maintain the same format as given in the input. "reason" is of string type which says the one-line reason why the candiate ranked in that particular position. In the provided example, there
