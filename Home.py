        ...
        completion = client.chat.completions.create(
                          ...
                          messages=[
                            {"role": "system", "content": f'''You are a recruiter now. Analyse how good the candidate information fits the following recruiting job description.
                                                           ...
                                                           You have to provide a recommendation for this candidate in less than 100 words. Strategically combine the personality traits, if any in information given in the candidate information.
